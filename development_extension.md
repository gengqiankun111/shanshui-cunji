...
## Ex-2 SAGA 编排 + 补偿状态机（跨分片业务事务，未来） — ✅ 已完成
...
## Ex-3 确定性事务评估（Calvin 思想，远期方向） — ✅ 已评估：不立项
...
## Ex-4 倒排索引字段策略落地（v0.2，2026-08-29） — ✅ 已完成
...
## Ex-5 SSD 原生迁移计划（v0.3，2026-08-29） — ✅ 已完成
